...
describe('Terminal Component - Simple Tests with Real Data', () => {
  ...
  it(
    'renders terminal component with real session data',
  ...
  it(
    'displays terminal content from real server session',
    withTestLogging(async () => {
  ...
  it(
    'handles different zoom modes with real session data',
    withTestLogging(async () => {
  ...
  it(
    'handles real terminal state with cursor information',
    withTestLogging(async () => {
  ...
  it(
    'processes real with multiple lines',
    withTestLogging(async () => {
  ...
  it(
    'handles real session with error output',
    withTestLogging(async () => {
  ...
  it(
    'maintains session structure integrity with real data',
    withTestLogging(async () => {
  ...
  it(
    'handles session updates with changing terminal state',
    withTestLogging(async () => {
